GitHub link: https://github.com/Kilo-Org/kilocode

## description:
Kilo Code is an open-source coding agent (an OpenCode-family fork). Captured on the **kilo/kilo-auto/free** model, which is reachable without a paid plan.
