...
- **Claude Code docs** ([https://code.claude.com/docs/en/claude_code_docs_map.md](https://code.claude.com/docs/en/claude_code_docs_map.md)): Fetch this for questions about the Claude Code CLI tool, including:
...
- **Claude Agent SDK docs** ([https://platform.claude.com/llms.txt](https://platform.claude.com/llms.txt)): Fetch this for questions about building agents with the SDK, including:
...
- **Claude API docs** ([https://platform.claude.com/llms.txt](https://platform.claude.com/llms.txt)): Fetch this for questions about the Claude API (formerly the Anthropic API), including:
